/* eslint-disable */
// @generated by protobuf-ts 2.9.4 with parameter eslint_disable,force_client_none
...
export interface ImageDetections {
  ...
  /**
   * @generated from protobuf field: detection.ImageDetections.Error error = 2;
   */
  error?: ImageDetections_Error;
}
/**
 * @generated from protobuf message detection.ImageDetections.Error
 */
export interface ImageDetections_Error {
  /**
   * @generated from protobuf field: detection.ImageDetections.ErrorCode code = 1;
   */
  code: ImageDetections_ErrorCode;
  /**
...
/**
 * @generated from protobuf enum detection.ImageDetections.ErrorCode
 */
export enum ImageDetections_ErrorCode {
  /**
   * @generated from protobuf enum value: InvalidImage = 0;
   */
  InvalidImage = 0,
  /**
   * @generated from protobuf enum value: MaxSizeExceeded = 1;
   */
  MaxSizeExceeded = 1,
  /**
...
export enum DetectErrorCode {
  /**
   * @generated from protobuf enum value: BadRequest = 0;
   */
  BadRequest = 0,
  /**
   * @generated from protobuf enum value: MaxRequestsExceeded = 1;
   */
  MaxRequestsExceeded = 1,
  /**
   * @generated from protobuf enum value: MaxImagesExceeded = 2;
   */
  MaxImagesExceeded = 2,
  /**
   * @generated from protobuf enum value: InternalError = 10;
...
class ImageDetections$Type extends MessageType<ImageDetections> {
  constructor() {
    super('detection.ImageDetections', [
      ...
      { no: 2, name: 'error', kind: 'message', T: () => ImageDetections_Error },
    ]);
  }
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        case /* repeated detection.Detection detections */ 1:
          ...
          break;
        case /* detection.ImageDetections.Error error */ 2:
          message.error = ImageDetections_Error.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.error,
  ...
  internalBinaryWrite(
    ...
    /* detection.ImageDetections.Error error = 2; */
    if (message.error)
      ImageDetections_Error.internalBinaryWrite(
        message.error,
        writer.tag(2, WireType.LengthDelimited).fork(),
        options,
      ).join();
...
// @generated message type with reflection information, may provide speed optimized methods
class ImageDetections_Error$Type extends MessageType<ImageDetections_Error> {
  constructor() {
    super('detection.ImageDetections.Error', [
      {
        no: 1,
        name: 'code',
        kind: 'enum',
        T: () => [
          'detection.ImageDetections.ErrorCode',
  ...
  create(value?: PartialMessage<ImageDetections_Error>): ImageDetections_Error {
    const message = globalThis.Object.create(this.messagePrototype!);
    message.code = 0;
    message.message = '';
    if (value !== undefined)
      reflectionMergePartial<ImageDetections_Error>(this, message, value);
    return message;
  }
  internalBinaryRead(
    reader: IBinaryReader,
    ...
    while (reader.pos < end) {
      let [fieldNo, wireType] = reader.tag();
      switch (fieldNo) {
        case /* detection.ImageDetections.ErrorCode code */ 1:
  ...
  internalBinaryWrite(
    message: ImageDetections_Error,
    writer: IBinaryWriter,
    options: BinaryWriteOptions,
  ): IBinaryWriter {
    /* detection.ImageDetections.ErrorCode code = 1; */
...
/**
 * @generated MessageType for protobuf message detection.ImageDetections.Error
 */
export const ImageDetections_Error = new ImageDetections_Error$Type();
// @generated message type with reflection information, may provide speed optimized methods
